const HeroSection = () => {
    return (  
      <main className="py-10 bg-cover bg-center bg-no-repeat font-Poppins" style={{ backgroundImage: "url('/arbol_fondo.png')" }}>
        <div className="pl-24 pr-96 flex flex-col space-y-8 py-52 drop-shadow-2xl">
          ...
          <button className="bg-moss-green text-white text-3xl w-80 h-16 border-dotted border-2 rounded-full hover:bg-green-700">QUIERO PLANTAR</button>
        </div>
      </main>
    );
  };
